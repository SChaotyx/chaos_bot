...
class embeds extends EventEmitter {
    levels(Data){
        ...
        embedData.setThumbnail(thumbnail["thumb"]);
    ...
    getDiffThumb(lvl){
        ...
        let Prom = new Promise((res,rej)=> {
            require('request').post({
                uri: process.env.HOSTING + "incl/discord/cmd/getThumbnail.php",
...
//GENERATEIMG URL
        ...
        //GENERATE FILENAME
		var imgurl = process.env.HOSTING + "resources/difficulty/"+rateimg+diffimg+str+".png";
        return imgurl;
*/
